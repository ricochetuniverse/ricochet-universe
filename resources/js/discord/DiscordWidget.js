...
export default class DiscordWidget extends Component {
    render() {
        return (
            <div>
                <a href={this.props.inviteLink} className="discordWidget__header">
                    <div className="discordWidget__logo">
                        <span className="sr-only">Discord</span>
                    </div>

                    <Button tag="span" outline color="secondary">Join</Button>
                </a>
                                    ...
                                    return (
                                        <li className="discordWidget__member">
                                            <div className="discordWidget__member__avatar">
                                                <img src={member.avatar_url} alt="" width={16} height={16}
                                                     className="discordWidget__member__avatar__image"/>
                                                <span
                                                    className={'discordWidget__member__avatar__status discordMemberStatus--' + member.status}/>
                                            </div>
                                            <span className="text-nowrap">{getDiscordMemberName(member)}</span>
                                        </li>
                                    );
                                })}
                            </ul>
